...
class AssetPaths
{
	...
	public static inline var PLAYER_BOT:String = "assets/egg(2).png";
	...
	public static inline var BOT_WALK:String = "assets/Wowiwiw.mp3";
	...
	public static inline var HURT_BOT_SFX:String = "assets/hurtSFX2(bot).mp3";
	public static inline var LAND_SFX:String = "assets/land.mp3";
	public static inline var UMBRELLA_SFX:String = "assets/umbrella.mp3";
	public static inline var FOLD_PAPER_SFX:String = "assets/foldpaper.mp3";
	public static inline var SLIDE_WHISTLE:String = "assets/slidewhistle.mp3";
